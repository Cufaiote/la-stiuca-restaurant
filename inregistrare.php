...
<body>
  ...
  <div class="container signup-form">
    <form class="col-md-offset-2 col-md-8" action="includeri-php/signup.php" method="post">
      <h2>Inregistrare</h2>
      <p>Completati formularul de mai jos pentru a va crea un cont! </p>
      <hr>
      ...
      <div class="form-group">
        <div class="input-group">
          ...
          <input type="text" class="form-control" name="telefon" placeholder="Telefon..." required="required">
        </div>
      </div>
      <div class="form-group">
        <div class="input-group">
      ...
      <div class="form-group">
        <div class="input-group">
          ...
          <input type="password" class="form-control" name="repetareParola" placeholder="Verificare Parola..." required="required">
        </div>
      </div>
      <div class="form-group">
        <button type="submit" class="btn btn-primary btn-lg center-block" name="buton-inregistrare">Trimite</button>
      </div>
    </form>
  </div>
